...
const proPlayers = [
  ...
  { name: "FalleN", game: "CS2", team: "FURIA", mouse: "Fallen Gear Lobo Wireless", hz: 1000, dpi: 400, sens: 1.8, edpi: 720, role: "AWPer/IGL", country: "🇧🇷", age: 34, fullName: "Gabriel Toledo",
    bio: "Gabriel 'FalleN' Toledo is the godfather of Brazilian Counter-Strike, the man who single-handedly proved that South America could not only compete at the highest level but dominate it entirely. As the in-game leader and primary AWPer of the legendary Luminosity Gaming and SK Gaming rosters, FalleN led his teams to back-to-back Major championships at MLG Columbus 2016 and ESL One Cologne 2016, a feat of consecutive Major victories that had not been achieved since the original NiP dynasty. His AWPing style combined surgical precision with an IGL's understanding of timing and positioning, making him one of the rare players who could frag at a star level while simultaneously calling strategies for his team. Beyond his in-game brilliance, FalleN's impact on Brazilian esports is immeasurable — he founded Games Academy to develop young talent, mentored an entire generation of players including coldzera, fer, and TACO, and essentially built the infrastructure that made Brazil a Counter-Strike powerhouse. His move to FURIA in 2024 represented a full-circle moment, returning to lead a new generation of Brazilian talent after years with Liquid and Imperial. FalleN is so revered in Brazil that he earned the nickname 'The Professor' for his tactical mind and willingness to teach, and his legacy extends far beyond any trophy case — he changed the geography of competitive Counter-Strike forever.",
    achievements: ["MLG Columbus Major 2016 Champion", "ESL One Cologne Major 2016 Champion", "ESL Pro League S3 Finals Champion", "EPICENTER 2017 Champion", "Back-to-back Major titles", "Founded Games Academy", "Intel Grand Slam contender", "Brazil's most influential esports figure", "15+ year professional career", "Known as 'The Professor' of CS"],
    mouseHistory: [{ mouse: "Fallen Gear Lobo Wireless", period: "2024-Present" }, { mouse: "Razer DeathAdder V3 Pro", period: "2023-2024" }, { mouse: "Zowie EC2-B", period: "2018-2023" }, { mouse: "Zowie EC2-A", period: "2015-2018" }],
  },
  { name: "coldzera", game: "CS2", team: "ODDIK", mouse: "ZOWIE ZA13-DW", hz: 2000, dpi: 800, sens: 1.1, edpi: 880, role: "Rifler", country: "🇧🇷", age: 30, fullName: "Marcelo David",
    bio: "Marcelo 'coldzera' David is the only player in Counter-Strike history to win the HLTV number one player in the world award in back-to-back years, claiming the title in both 2016 and 2017 with a level of statistical dominance that redefined what was possible for a rifler. During the SK Gaming dynasty, coldzera's combination of perfect crosshair placement, clutch performance under pressure, and an almost inhuman ability to win multi-kill rounds made him the most feared player on the server. His iconic jumping AWP double kill on Mirage at MLG Columbus 2016 remains perhaps the single most replayed moment in Counter-Strike history, a play so improbable that it became a defining clip of the entire esport. As the star player of the back-to-back Major winning roster, coldzera proved that a Brazilian player could not only compete with but utterly outclass the best European talent in the game. His consistency across 2016 and 2017 produced tournament ratings that remain among the highest ever recorded for a rifler over a sustained period, with multiple events where he posted 1.30+ ratings against top competition. After the SK era, coldzera's journey through FaZe Clan, Team Liquid, and eventual return to Brazilian rosters showed a player who maintained elite mechanical skill even as the landscape around him shifted. His legacy as one of the three or four greatest players in Counter-Strike history is secure, and his influence on how the lurker and second-star roles are played continues to resonate throughout the professional scene.",
    achievements: ["HLTV #1 Player 2016", "HLTV #1 Player 2017", "MLG Columbus Major 2016 Champion", "ESL One Cologne Major 2016 Champion", "ESL Pro League S3 Finals Champion", "EPICENTER 2017 Champion", "HLTV Top 5 four consecutive years", "Most iconic play in CS history (Mirage AWP)", "Multiple HLTV MVP Awards", "Back-to-back Major champion"],
    mouseHistory: [{ mouse: "ZOWIE ZA13-DW", period: "2024-Present" }, { mouse: "Zowie EC2-CW", period: "2022-2024" }, { mouse: "Zowie EC2-B", period: "2019-2022" }, { mouse: "Zowie EC2-A", period: "2016-2019" }],
  },
  { name: "olofmeister", game: "CS2", team: "FaZe Clan", mouse: "Logitech G Pro X Superlight 2", hz: 2000, dpi: 800, sens: 1.25, edpi: 1000, role: "Rifler", country: "🇸🇪", age: 33, fullName: "Olof Kajbjer",
    bio: "Olof 'olofmeister' Kajbjer was the most dominant Counter-Strike player in the world during 2015, a year in which he led Fnatic to an unprecedented era of dominance that included a Major championship at ESL One Katowice 2015 and an unbroken streak of tournament victories that cemented Fnatic as the greatest team of that era. His HLTV number one ranking in 2015 was built on a foundation of fearless aggression and clutch playmaking that made him the prototype for the modern star rifler. Olofmeister's versatility was legendary — he could AWP at a world-class level, entry frag with reckless confidence, and anchor bombsites with the patience of a veteran, often switching between all three roles within a single match. The 'olofpass' boost on Overpass at DreamHack Winter 2014, where Fnatic used a controversial pixel-perfect boost to gain an impossible vantage point, became one of the most infamous and memorable moments in CS history. His partnership with Fnatic teammates KRIMZ and flusha formed the core of a Swedish dynasty that won two Major championships and dominated the international circuit for nearly two years. A wrist injury in 2016 robbed olofmeister of his peak form, and while he never quite recaptured the heights of his 2015 dominance, his subsequent career with FaZe Clan — including being part of the PGL Major Antwerp 2022 championship roster — proved his enduring quality. Olofmeister's legacy is that of the player who showed the world what a truly complete Counter-Strike player looked like, equally dangerous with any weapon on any map in any situation.",
    achievements: ["HLTV #1 Player 2015", "ESL One Katowice Major 2015 Champion", "DreamHack Winter Major 2014 Champion (Fnatic)", "PGL Major Antwerp 2022 Champion (FaZe)", "3× Major Champion", "ESL ESEA Pro League S1 Champion", "Multiple HLTV MVP Awards", "Intel Extreme Masters victories", "Known for 'olofpass' boost", "Part of Fnatic dynasty 2014-2016"],
    mouseHistory: [{ mouse: "Logitech G Pro X Superlight 2", period: "2023-Present" }, { mouse: "Logitech G Pro X Superlight", period: "2021-2023" }, { mouse: "Zowie EC2-A", period: "2018-2021" }, { mouse: "SteelSeries Rival", period: "2014-2018" }],
  },
  { name: "karrigan", game: "CS2", team: "FaZe Clan", mouse: "Corsair Sabre v2 Pro", hz: 1000, dpi: 800, sens: 0.9, edpi: 720, role: "IGL", country: "🇩🇰", age: 35, fullName: "Finn Andersen",
    bio: "Finn 'karrigan' Andersen is the greatest redemption story in Counter-Strike history, an in-game leader who spent nearly a decade building rosters, getting cut at the cusp of glory, and ultimately persevering to win the PGL Major Antwerp 2022 with FaZe Clan in what is widely considered one of the most emotionally powerful moments the esport has ever produced. Karrigan's journey through some of the biggest organizations in CS — including Astralis (then TSM/dignitas), FaZe Clan, mousesports, and back to FaZe — reads like a Hollywood script of heartbreak and triumph. He was famously removed from the Astralis core that would go on to become the greatest dynasty in CS:GO history, a decision that could have defined his career as a cautionary tale but instead fueled an almost obsessive determination to prove his worth as a leader. Under karrigan's guidance, FaZe Clan assembled the 2022 super-roster of rain, Twistzz, broky, and ropz that won the Major, IEM Katowice, IEM Cologne, and the Intel Grand Slam Season 4 in what was the most dominant run by any team that year. His calling style prioritizes reading opponents in real-time and making mid-round adjustments rather than relying on rigid set executes, a loose approach that requires immense trust from his teammates but produces unpredictable, creative Counter-Strike when it clicks. At 35, karrigan is one of the oldest active professional players, and his longevity at the highest level across multiple decades and game versions is a testament to the enduring value of elite leadership in a sport that increasingly favors youth and raw mechanics.",
    achievements: ["PGL Major Antwerp 2022 Champion", "IEM Katowice 2022 Champion", "IEM Cologne 2022 Champion", "Intel Grand Slam Season 4", "BLAST Premier World Final 2022 Champion", "ESL Pro League S15 Champion", "IEM Katowice 2022 MVP", "15+ year professional career", "Led 3 different orgs to top 5 world ranking", "Oldest active Major champion"],
    mouseHistory: [{ mouse: "Corsair Sabre v2 Pro", period: "2023-Present" }, { mouse: "Logitech G Pro X Superlight", period: "2021-2023" }, { mouse: "Zowie EC2-A", period: "2017-2021" }, { mouse: "SteelSeries Rival 300", period: "2015-2017" }],
  },
  { name: "gla1ve", game: "CS2", team: "Free Agent", mouse: "Logitech G Pro X Superlight", hz: 1000, dpi: 400, sens: 1.8, edpi: 720, role: "IGL", country: "🇩🇰", age: 30, fullName: "Lukas Rossander",
    bio: "Lukas 'gla1ve' Rossander is the architect of the most dominant dynasty in Counter-Strike history, the in-game leader who transformed Astralis from a talented but inconsistent Danish roster into a machine that won four Major championships between 2018 and 2019 — a feat of sustained excellence that no other team has come close to replicating. Gla1ve joined Astralis in early 2017 and the transformation was immediate: within months, a team that had been underperforming relative to its talent was winning everything in sight. His tactical framework revolutionized how professional Counter-Strike was played, introducing a level of utility usage, timing coordination, and structured decision-making that forced every other team in the world to adapt or fall behind. The Astralis era of 2018-2019, during which they won the FACEIT Major 2018, IEM Katowice Major 2019, StarLadder Berlin Major 2019, and the Intel Grand Slam Season 1, remains the gold standard of team Counter-Strike. What made gla1ve's system so devastating was its adaptability — Astralis could play fast or slow, aggressive or passive, structured or loose, all within the same match depending on what the opponent gave them. Beyond pure tactics, gla1ve was instrumental in Astralis pioneering player wellness in esports, including the controversial but forward-thinking use of a six-man roster to manage burnout and maintain peak performance. His willingness to sacrifice individual statistics for team success exemplifies the selfless leadership that defined Astralis, and his impact on how the IGL role is viewed — from a necessary burden to a prestigious, skill-intensive position — has permanently elevated the profession.",
    achievements: ["FACEIT Major 2018 Champion", "IEM Katowice Major 2019 Champion", "StarLadder Berlin Major 2019 Champion", "PGL Major Stockholm 2021 Champion", "4× Major Champion", "Intel Grand Slam Season 1", "BLAST Premier Global Final 2019", "IEM Katowice 2019 MVP", "Pioneered six-man roster model", "Most Major titles as IGL"],
    mouseHistory: [{ mouse: "Logitech G Pro X Superlight", period: "2021-Present" }, { mouse: "Logitech G Pro Wireless", period: "2019-2021" }, { mouse: "Zowie EC2-B", period: "2017-2019" }, { mouse: "SteelSeries Rival 300", period: "2015-2017" }],
  },
  { name: "dupreeh", game: "CS2", team: "Free Agent", mouse: "Logitech G Pro X Superlight", hz: 1000, dpi: 400, sens: 1.8, edpi: 720, role: "Entry", country: "🇩🇰", age: 32, fullName: "Peter Rasmussen",
    bio: "Peter 'dupreeh' Rasmussen holds the record that may never be broken in Counter-Strike: four Major championship titles, more than any other player in the history of the game. As the entry fragger and emotional engine of the Astralis dynasty, dupreeh was the player who converted gla1ve's tactical frameworks into explosive opening kills, throwing his body onto bombsites with a fearlessness that belied the precision and preparation behind every peek. His four Majors — FACEIT London 2018, IEM Katowice 2019, StarLadder Berlin 2019, and PGL Stockholm 2021 — span a period of dominance that saw him consistently perform at an elite level against every era of competition. What made dupreeh extraordinary was his ability to reinvent himself: he transitioned from a pure entry fragger to a more hybrid role incorporating AWPing and lurking as Astralis evolved, showing a versatility that kept opponents guessing and extended his relevance far beyond what a one-dimensional player could achieve. During Astralis' peak, dupreeh's opening duel statistics were among the best in the world, and his willingness to take the hardest assignments — the first peek, the difficult retake, the clutch round — made him the backbone that the system relied upon. His move to Team Vitality alongside Magisk in 2022 showed that his talent transcended the Astralis system, as he continued to compete at the highest level in a completely different tactical environment. Dupreeh's legacy is that of the ultimate team player who happened to also be individually brilliant — a player whose selfless aggression enabled the greatest dynasty the game has ever known, and whose four Major rings may stand as the record for generations to come.",
    achievements: ["FACEIT Major 2018 Champion", "IEM Katowice Major 2019 Champion", "StarLadder Berlin Major 2019 Champion", "PGL Major Stockholm 2021 Champion", "4× Major Champion (most ever)", "Intel Grand Slam Season 1", "BLAST Premier Global Final 2019", "ESL Pro League S10 Champion", "Most Majors won by any player", "Astralis core member 2016-2022"],
    mouseHistory: [{ mouse: "Logitech G Pro X Superlight", period: "2021-Present" }, { mouse: "Logitech G Pro Wireless", period: "2019-2021" }, { mouse: "Zowie EC2-B", period: "2017-2019" }, { mouse: "SteelSeries Rival 300", period: "2015-2017" }],
  },
  { name: "Xyp9x", game: "CS2", team: "Free Agent", mouse: "Logitech G Pro Wireless", hz: 1000, dpi: 400, sens: 2.5, edpi: 1000, role: "Support", country: "🇩🇰", age: 30, fullName: "Andreas Højsleth",
    bio: "Andreas 'Xyp9x' Højsleth earned the nickname 'The Clutch Minister' through an almost supernatural ability to win rounds that were statistically lost, turning one-versus-two and one-versus-three situations into highlight reels with a consistency that defied probability across hundreds of professional matches. As the support player and clutch specialist of the Astralis dynasty, Xyp9x was the safety net that allowed his teammates to take aggressive risks knowing that if everything fell apart, their anchor could salvage the round through sheer composure and game sense. His four Major championships with Astralis tie him with dupreeh and gla1ve for the most Major titles in Counter-Strike history, a record that reflects his irreplaceable role in the greatest team the game has ever seen. What made Xyp9x's clutch ability so remarkable was that it wasn't built on flashy mechanical plays but on an encyclopedic knowledge of every angle, timing, and utility combination on every map — he simply knew where opponents would be and how to exploit the smallest positional advantages when the pressure was at its absolute peak. During Astralis' dominant 2018-2019 period, his clutch round conversion rate was the highest in professional CS by a significant margin, a statistical anomaly that persisted over hundreds of rounds against the best players in the world. Xyp9x took a break from competitive play in 2020 citing burnout, a courageous decision that helped normalize mental health conversations in esports and demonstrated that even the most successful players are human. His legacy is unique in Counter-Strike — he may not have the aim of s1mple or the tactical mind of gla1ve, but no player in history has been more reliable when everything is on the line.",
    achievements: ["FACEIT Major 2018 Champion", "IEM Katowice Major 2019 Champion", "StarLadder Berlin Major 2019 Champion", "PGL Major Stockholm 2021 Champion", "4× Major Champion", "Intel Grand Slam Season 1", "Highest clutch win rate in CS history", "Known as 'The Clutch Minister'", "BLAST Premier Global Final 2019", "Astralis core member 2016-2022"],
    mouseHistory: [{ mouse: "Logitech G Pro Wireless", period: "2019-Present" }, { mouse: "Zowie EC2-B", period: "2017-2019" }, { mouse: "SteelSeries Rival 300", period: "2015-2017" }],
  },
  { name: "Magisk", game: "CS2", team: "Free Agent", mouse: "Logitech G Pro X Superlight 2", hz: 1000, dpi: 800, sens: 1.0, edpi: 800, role: "Rifler", country: "🇩🇰", age: 27, fullName: "Emil Reif",
    bio: "Emil 'Magisk' Reif was the final piece of the Astralis puzzle, joining the roster in early 2018 and immediately elevating the team from a strong contender to the most dominant force Counter-Strike has ever seen. His arrival coincided perfectly with Astralis' tactical evolution under gla1ve, and Magisk's combination of reliable fragging, versatile role-filling, and unshakeable mental fortitude made him the ideal complement to the existing core. In his first year with Astralis, the team won two Major championships — FACEIT London 2018 and IEM Katowice 2019 — a rate of trophy accumulation that would define the most successful period in CS:GO history. Magisk's playstyle is defined by consistency rather than flashiness: he rarely has the highest-rated performance on his team, but he almost never has a bad game, providing a floor of excellence that allows his more volatile teammates to take risks. His three Major titles with Astralis established him as one of the most decorated players of the CS:GO era, and his subsequent move to Team Vitality alongside dupreeh showed his ability to perform at the top level outside the Astralis system. Before Astralis, Magisk had already shown his potential on OpTic Gaming (later North), where he won ELEAGUE Season 2 and established himself as one of Denmark's most promising young talents. His career arc from promising youngster to dynasty cornerstone to respected veteran represents the ideal trajectory for a professional Counter-Strike player, and his three Major rings ensure his place in the game's hall of fame.",
    achievements: ["FACEIT Major 2018 Champion", "IEM Katowice Major 2019 Champion", "StarLadder Berlin Major 2019 Champion", "3× Major Champion", "Intel Grand Slam Season 1", "ELEAGUE Season 2 Champion (OpTic)", "BLAST Premier Global Final 2019", "IEM Beijing 2019 Champion", "Astralis core member 2018-2022", "Team Vitality member 2022-2023"],
    mouseHistory: [{ mouse: "Logitech G Pro X Superlight 2", period: "2024-Present" }, { mouse: "Logitech G Pro X Superlight", period: "2021-2024" }, { mouse: "Logitech G Pro Wireless", period: "2019-2021" }, { mouse: "Zowie EC2-B", period: "2017-2019" }],
  },
  { name: "Ax1Le", game: "CS2", team: "Natus Vincere", mouse: "Logitech G Pro X Superlight 2", hz: 1000, dpi: 400, sens: 1.4, edpi: 560, role: "Rifler", country: "🇷🇺", age: 23, fullName: "Sergey Rykhtorov",
    bio: "Sergey 'Ax1Le' Rykhtorov is one of the most mechanically gifted riflers to emerge from the CIS region, a player whose raw aim and spray control have drawn comparisons to the very best individual talents Counter-Strike has ever produced. He first gained widespread recognition on Gambit Youngsters before being promoted to the main Gambit roster, where he played a crucial role in the team's stunning PGL Major Stockholm 2021 victory — one of the biggest underdog stories in Major history. At the Shanghai Major 2024, Ax1Le was instrumental in Team Spirit's championship run, proving his ability to perform on the biggest stages across different rosters and eras. His playing style combines aggressive peek timing with exceptional spray transfer ability, allowing him to win multi-kill duels that most players would never attempt. The transition from Gambit to Cloud9 to Natus Vincere has seen Ax1Le consistently perform at an elite level regardless of the system around him, a testament to the transferability of his individual talent. His multiple HLTV Top 20 placements confirm what the eye test suggests — Ax1Le is one of the ten or fifteen best players in the world in any given year, a quiet superstar whose statistical output rivals that of players who receive far more attention and fanfare.",
    achievements: ["PGL Major Stockholm 2021 Champion (Gambit)", "PGL Major Shanghai 2024 Champion (Spirit)", "2× Major Champion", "HLTV Top 20 Player (multiple years)", "IEM Katowice 2024 deep run", "BLAST Premier appearances", "Gambit Youngsters to Major champion", "Natus Vincere franchise rifler", "Known for elite spray control", "Consistent top-tier performer since 2021"],
    mouseHistory: [{ mouse: "Logitech G Pro X Superlight 2", period: "2024-Present" }, { mouse: "Logitech G Pro X Superlight", period: "2022-2024" }, { mouse: "Logitech G Pro Wireless", period: "2020-2022" }],
  },
  { name: "Brollan", game: "CS2", team: "MOUZ", mouse: "ZOWIE EC2-CW", hz: 2000, dpi: 800, sens: 1.15, edpi: 920, role: "Rifler", country: "🇸🇪", age: 22, fullName: "Ludvig Brolin",
    bio: "Ludvig 'Brollan' Brolin became the youngest player to win a CS:GO Big Event when he led Fnatic to victory at DreamHack Masters Malmö 2019 at just sixteen years old, announcing the arrival of a Swedish prodigy whose mechanical talent was already world-class before he could legally drive. His rapid ascent through the Fnatic academy and into the main roster drew comparisons to f0rest and GeT_RiGhT, and the Swedish scene embraced him as the heir apparent to a legacy of dominance that had defined the country's relationship with Counter-Strike. On MOUZ, Brollan has found a home that maximizes his aggressive rifling style, forming the core of a roster that has consistently challenged the world's best teams. His aim is characterized by lightning-fast flick reactions and an ability to win aim duels at close range that borders on the preternatural, making him one of the most dangerous players to encounter in a direct firefight. Brollan's consistency across multiple rosters and tactical systems demonstrates that his talent transcends any single team's approach, and his continued presence in the HLTV Top 20 conversation confirms his standing among the game's elite. At 22, Brollan is entering what should be his prime years, and the Counter-Strike community widely expects his best achievements are still ahead of him.",
    achievements: ["DreamHack Masters Malmö 2019 Champion", "Youngest Big Event winner in CS:GO", "ESL Pro League S18 Champion (MOUZ)", "HLTV Top 20 Player (multiple years)", "Fnatic franchise player 2019-2022", "MOUZ core member since 2022", "Known for exceptional close-range aim", "Multiple Tier 1 deep runs", "Sweden's brightest CS talent of new generation", "IEM Cologne 2024 Semi-finalist"],
    mouseHistory: [{ mouse: "ZOWIE EC2-CW", period: "2022-Present" }, { mouse: "Zowie EC2-B", period: "2019-2022" }, { mouse: "Zowie EC2-A", period: "2018-2019" }],
  },
  { name: "Jimpphat", game: "CS2", team: "MOUZ", mouse: "Logitech G Pro X Superlight 2", hz: 1000, dpi: 400, sens: 1.5, edpi: 600, role: "Rifler", country: "🇫🇮", age: 18, fullName: "Jimi Salo",
    bio: "Jimi 'Jimpphat' Salo is the Finnish wunderkind who joined MOUZ's main roster at just fifteen years old, making him one of the youngest players to ever compete at the highest level of professional Counter-Strike. His debut was not a cautious introduction but an immediate statement of intent — Jimpphat played with a confidence and composure that seemed impossible for someone his age, holding his own against players with a decade more experience. The ESL Pro League Season 18 championship was Jimpphat's breakout moment, proving that his talent could translate into trophies against the world's best opposition. His playing style is remarkably mature for his age, combining patient positioning with explosive aggression when opportunities present themselves, a duality that suggests he has already internalized lessons that many players take years to learn. Finland has produced legendary Counter-Strike players before — allu and suNny among them — but Jimpphat represents a generational leap in Finnish talent that could see the country produce its first truly transcendent CS star. His partnership with Brollan, torzsi, and the MOUZ system has created a roster that is built for both present success and future dominance, with Jimpphat at its core as the franchise player around whom the team's future is being constructed.",
    achievements: ["ESL Pro League S18 Champion", "Youngest MOUZ roster member ever", "HLTV Top 20 Player 2024", "IEM Cologne 2024 Semi-finalist", "MOUZ franchise star", "Competed at Tier 1 since age 15", "Multiple BLAST Premier appearances", "Finland's most promising CS talent", "Known for composure beyond his years", "Rising HLTV MVP contender"],
    mouseHistory: [{ mouse: "Logitech G Pro X Superlight 2", period: "2023-Present" }, { mouse: "Logitech G Pro X Superlight", period: "2022-2023" }],
  },
  { name: "blameF", game: "CS2", team: "BIG", mouse: "Logitech G Pro X Superlight", hz: 1000, dpi: 400, sens: 1.6, edpi: 640, role: "IGL/Rifler", country: "🇩🇰", age: 28, fullName: "Benjamin Bremer",
    bio: "Benjamin 'blameF' Bremer shattered the conventional wisdom that in-game leaders must sacrifice individual statistics for the good of the team, consistently posting star-player ratings while simultaneously calling strategies for his teams. His unique approach to the IGL role treats it as additive rather than restrictive — blameF designs systems that create space for himself to frag while also empowering his teammates, a philosophy that has produced some of the highest individual ratings by any IGL in Counter-Strike history. On Complexity, he turned a mid-tier roster into a team that could challenge top opposition, and his subsequent move to Astralis showed that his methods could scale to a more talented lineup. His current tenure at BIG has rejuvenated the German organization, bringing a level of tactical sophistication and individual firepower that has made them a consistent threat in European competition. BlameF's physical conditioning is legendary in esports — he is one of the most visibly fit professional gamers, and his disciplined approach to fitness mirrors the meticulous preparation he brings to Counter-Strike. His playstyle as a fragging IGL has inspired a new generation of leaders who refuse to accept that calling and carrying are mutually exclusive, and his career statistics would be impressive for a pure rifler, let alone someone managing the cognitive load of in-game leadership.",
    achievements: ["ESL Pro League S12 North America Champion", "Multiple Tier 1 playoff appearances", "Highest-rated IGL in CS history (by period)", "Astralis IGL 2022-2023", "BIG franchise leader", "Known for physical fitness regimen", "HLTV Top 20 Player 2020", "Multiple BLAST Premier deep runs", "Redefined fragging IGL role", "Complexity dynasty architect"],
    mouseHistory: [{ mouse: "Logitech G Pro X Superlight", period: "2021-Present" }, { mouse: "Logitech G Pro Wireless", period: "2019-2021" }, { mouse: "Zowie EC2-B", period: "2017-2019" }],
  },
  { name: "NAF", game: "CS2", team: "Team Liquid", mouse: "Logitech G Pro X Superlight 2", hz: 4000, dpi: 800, sens: 0.8, edpi: 640, role: "Rifler", country: "🇨🇦", age: 27, fullName: "Keith Markovic",
    bio: "Keith 'NAF' Markovic is the quiet cornerstone of North American Counter-Strike, a player whose understated brilliance and remarkable consistency have made him one of the most respected riflers in the game's history despite rarely receiving the spotlight that flashier players command. During Team Liquid's legendary 2019 run — which saw them win IEM Sydney, DreamHack Masters Dallas, ESL Pro League Season 9 Finals, and IEM Chicago to claim the Intel Grand Slam Season 2 — NAF was arguably the team's most important player, providing the reliable foundation upon which EliGE and Twistzz could build their more explosive performances. His HLTV number four ranking in 2018 remains one of the highest placements by a North American player in the modern era, reflecting a year of sustained excellence that put him in conversation with the world's absolute best. NAF's playing style is defined by immaculate positioning and crosshair placement, rarely relying on flashy mechanics when superior game sense can achieve the same result with far less risk. His longevity with Team Liquid through multiple roster iterations speaks to his adaptability and the universal respect his teammates and coaches have for his contributions. In an era where North American Counter-Strike has struggled to maintain relevance against European and CIS competition, NAF has been the one constant — the player who shows up, performs at an elite level, and rarely if ever has a tournament where he is the reason his team loses.",
    achievements: ["Intel Grand Slam Season 2 (Liquid)", "IEM Sydney 2019 Champion", "DreamHack Masters Dallas 2019 Champion", "ESL Pro League S9 Finals Champion", "IEM Chicago 2019 Champion", "HLTV #4 Player 2018", "HLTV Top 20 (multiple years)", "Longest-tenured Liquid CS player", "BLAST Premier Spring 2020 Champion", "North America's most consistent rifler"],
    mouseHistory: [{ mouse: "Logitech G Pro X Superlight 2", period: "2024-Present" }, { mouse: "Logitech G Pro X Superlight", period: "2021-2024" }, { mouse: "Logitech G Pro Wireless", period: "2019-2021" }],
  },
  { name: "stavn", game: "CS2", team: "Free Agent", mouse: "ZOWIE EC2-CW", hz: 1000, dpi: 400, sens: 2.5, edpi: 1000, role: "Rifler", country: "🇩🇰", age: 23, fullName: "Martin Lund",
    bio: "Martin 'stavn' Lund is the player who carried HEROIC from a promising Danish lineup into a genuine contender against the world's best teams, a star rifler whose individual performances consistently elevated his team beyond what their collective talent level would suggest. His multiple HLTV Top 20 placements reflect a sustained level of excellence that few players outside the absolute elite rosters can maintain, and his ability to produce highlight-reel moments in the biggest matches has made him one of the most exciting players to watch in professional Counter-Strike. Stavn's career trajectory mirrors the journey of Danish Counter-Strike talent development — identified young, developed through the Danish system, and refined into a world-class player capable of carrying against any opposition. His rifle mechanics combine crisp spray control with exceptional movement, allowing him to take and win aim duels from angles that most players would consider disadvantageous. Despite HEROIC never quite breaking through to win a Major, stavn's individual performances at Major events have consistently been among the best in the tournament, earning him recognition as one of the greatest players to never win CS's biggest prize. His status as a free agent makes him one of the most sought-after players on the market, with virtually every top organization recognizing that stavn brings both star-level firepower and the professionalism of a veteran.",
    achievements: ["HLTV Top 20 Player (multiple years)", "ESL Pro League S16 Champion (HEROIC)", "BLAST Premier Spring Final 2022 deep run", "PGL Major Antwerp 2022 Semi-finalist", "HEROIC franchise star player", "Denmark's most consistent young talent", "Multiple HLTV MVP nominations", "Known for carry performances", "IEM Katowice deep runs", "One of CS's best free agents"],
    mouseHistory: [{ mouse: "ZOWIE EC2-CW", period: "2022-Present" }, { mouse: "Zowie EC2-B", period: "2019-2022" }, { mouse: "Zowie EC2-A", period: "2018-2019" }],
  },
  { name: "YEKINDAR", game: "CS2", team: "FURIA", mouse: "ZOWIE EC2-DW", hz: 1000, dpi: 800, sens: 1.2, edpi: 960, role: "Entry", country: "🇱🇻", age: 25, fullName: "Mareks Gaļinskis",
    bio: "Mareks 'YEKINDAR' Gaļinskis is the most explosive entry fragger in modern Counter-Strike, a player whose aggressive W-key style and willingness to take fights that no one else would dare attempt have made him one of the most electrifying players in the professional scene. His breakout on Virtus.pro saw him earn HLTV Top 10 status through a playstyle so aggressive that analysts initially dismissed it as unsustainable — yet YEKINDAR maintained his impact across hundreds of maps, proving that his aggression was calculated rather than reckless. The move to Team Liquid as a stand-in that became permanent demonstrated the universal appeal of his skillset: even in a structured North American system vastly different from VP's loose European approach, YEKINDAR's opening duels and space creation were immediately impactful. His time on Liquid was defined by moments of individual brilliance that reminded the CS community why pure mechanical talent still matters in an increasingly tactical game. Now with FURIA alongside FalleN, YEKINDAR brings his signature aggression to a Brazilian roster that thrives on fast-paced, pressure-heavy Counter-Strike. Latvia has never been a traditional Counter-Strike powerhouse, but YEKINDAR has single-handedly put the country on the CS map, inspiring young Latvian players who now have a world-class role model in their own country.",
    achievements: ["HLTV #8 Player 2021", "HLTV Top 20 (multiple years)", "IEM Fall 2021 Champion (VP)", "BLAST Premier Fall Final 2021", "Team Liquid franchise player 2022-2024", "FURIA entry fragger 2024-Present", "Known as most aggressive entry in CS", "Latvia's greatest CS player", "Multiple HLTV MVP nominations", "Redefined entry fragging in CS2"],
    mouseHistory: [{ mouse: "ZOWIE EC2-DW", period: "2024-Present" }, { mouse: "Zowie EC2-CW", period: "2022-2024" }, { mouse: "Zowie EC2-B", period: "2020-2022" }],
  },
  { name: "kscerato", game: "CS2", team: "FURIA", mouse: "Logitech G Pro X2 SUPERSTRIKE", hz: 2000, dpi: 400, sens: 3.0, edpi: 1200, role: "Rifler", country: "🇧🇷", age: 25, fullName: "Kaike Cerato",
    bio: "Kaike 'kscerato' Cerato is the most consistent Brazilian rifler since coldzera, a player whose mechanical precision and unshakeable composure under pressure have made him the backbone of FURIA's rise from regional hopeful to global contender. His statistics across the past four years tell a story of relentless excellence — kscerato maintains a positive rating against virtually every team in the world, a consistency that is extraordinarily rare among players who face top competition regularly. His playing style is built on crosshair discipline that borders on obsessive, with a placement accuracy that allows him to win opening duels through preparation rather than reaction, making him one of the most efficient aimers in professional Counter-Strike. FURIA's multiple deep runs at Major championships and Tier 1 events have been built largely on kscerato's ability to deliver star-level performances regardless of the opponent or the stakes. Unlike many Brazilian stars who play with aggressive flair, kscerato's game is defined by clinical efficiency — he takes the shots he should take, holds the angles he should hold, and produces the statistics his team needs with a reliability that coaches dream of. His continued loyalty to FURIA throughout their growth from a domestic Brazilian team to an internationally competitive roster reflects a commitment to the project that has been rewarded with consistent improvement and increasing global recognition.",
    achievements: ["ESL Pro League S16 deep run", "PGL Major Copenhagen 2024 competitor", "FURIA franchise rifler", "HLTV Top 20 Player (multiple years)", "Brazil's most consistent rifler since coldzera", "IEM Katowice deep runs", "Multiple BLAST Premier appearances", "Known for exceptional crosshair placement", "FURIA's longest-tenured star", "Positive rating vs virtually all top teams"],
    mouseHistory: [{ mouse: "Logitech G Pro X2 SUPERSTRIKE", period: "2025-Present" }, { mouse: "Logitech G Pro X Superlight 2", period: "2023-2025" }, { mouse: "Logitech G Pro X Superlight", period: "2021-2023" }],
  },
  { name: "Perfecto", game: "CS2", team: "Virtus.pro", mouse: "Waizowl OGM Cloud 8K", hz: 1000, dpi: 800, sens: 1.2, edpi: 960, role: "Support", country: "🇷🇺", age: 25, fullName: "Ilya Zalutskiy",
    bio: "Ilya 'Perfecto' Zalutskiy was the unsung hero of Natus Vincere's championship era, the support player who sacrificed individual glory to enable s1mple and electronic to dominate from their preferred positions. His role on NaVi required him to play the least glamorous positions on every map — anchoring weak sides, taking late rotations, and accepting the utility-heavy assignments that produce low frag counts but are essential to team success. When NaVi won the PGL Major Antwerp 2022, Perfecto's contribution went far beyond his statistics: his ability to hold bombsites reliably, gather information without dying, and occasionally clutch crucial rounds gave the team the structural stability that their star players needed to shine. What makes Perfecto's career remarkable is his growth — he joined NaVi as a relatively unknown CIS talent and evolved into one of the most reliable support players in the world, earning respect from teammates and opponents alike through his selfless approach. His move to Virtus.pro has given him more freedom to showcase his individual ability, and his fragging output has increased accordingly, suggesting that he was always capable of more but chose to subordinate his game for the team. Perfecto represents the category of player that every championship team needs but few fans appreciate — the glue player whose absence would cause the entire structure to collapse.",
    achievements: ["PGL Major Antwerp 2022 Champion", "Intel Grand Slam Season 4 (NaVi)", "BLAST Premier World Final 2021", "ESL One Cologne 2021 Champion", "IEM Katowice 2022 Champion", "NaVi core member 2020-2024", "Virtus.pro franchise player", "Known for selfless support play", "Multiple Tier 1 championships", "s1mple era NaVi contributor"],
    mouseHistory: [{ mouse: "Waizowl OGM Cloud 8K", period: "2024-Present" }, { mouse: "Logitech G Pro X Superlight", period: "2021-2024" }, { mouse: "Logitech G Pro Wireless", period: "2020-2021" }],
  },
  { name: "flameZ", game: "CS2", team: "Team Vitality", mouse: "ZOWIE EC2-DW", hz: 1000, dpi: 400, sens: 3.0, edpi: 1200, role: "Rifler", country: "🇮🇱", age: 21, fullName: "Shahar Shushan",
    bio: "Shahar 'flameZ' Shushan is the brightest star of Israeli Counter-Strike, a rifler whose explosive aim and aggressive confidence have carried him from the ENCE roster to one of the most prestigious positions in the game — starring alongside ZywOo on Team Vitality. His IEM Katowice 2025 championship with Vitality confirmed what many had long suspected: flameZ possesses the individual talent to be a franchise star on a championship-caliber roster, not merely a complementary piece but a genuine second star who can take over maps when needed. Israel has produced a remarkable cluster of CS talent in recent years including Spinx, xertioN, and HeavyGod, but flameZ stands above them all as the player most likely to challenge for HLTV Top 10 status in the coming years. His playing style is characterized by unusually high sensitivity for a professional player, which enables lightning-fast flick shots and 180-degree turns that catch opponents off guard with their speed. On Vitality, flameZ has been given the freedom to play aggressively and create chaos on bombsites, a role that perfectly suits his temperament and mechanical strengths. His rapid improvement trajectory since joining the international circuit suggests a player who is still learning and growing, with his ceiling far above his current — already impressive — level of play.",
    achievements: ["IEM Katowice 2025 Champion (Vitality)", "BLAST Austin Major 2025 Champion", "ENCE franchise player 2022-2024", "Team Vitality star rifler", "Israel's greatest CS player", "HLTV Top 20 contender", "Multiple Tier 1 deep runs", "Known for aggressive rifling style", "Rising Israeli CS talent pipeline leader", "PGL Major appearances"],
    mouseHistory: [{ mouse: "ZOWIE EC2-DW", period: "2024-Present" }, { mouse: "Zowie EC2-CW", period: "2022-2024" }, { mouse: "Zowie EC2-B", period: "2021-2022" }],
  },
  { name: "woxic", game: "CS2", team: "Aurora", mouse: "Razer Viper V3 Pro", hz: 8000, dpi: 1600, sens: 1.0, edpi: 1600, role: "AWPer", country: "🇹🇷", age: 24, fullName: "Özgür Eker",
    bio: "Özgür 'woxic' Eker is the most mechanically gifted AWPer Turkey has ever produced and one of the most unconventional players in professional Counter-Strike, famous for playing at an extraordinarily high sensitivity of 1600 DPI that would be considered unplayable by most professionals. His high-sensitivity playstyle enables a fluidity of movement and snap-aiming speed that looks almost alien compared to the controlled, methodical approach of most professional AWPers, producing highlight clips that seem physically impossible. Woxic first gained international recognition on HellRaisers before joining mousesports in 2019, where he was instrumental in the team's resurgence as a Tier 1 contender, winning multiple big events alongside karrigan. His AWPing combines the speed of a high-sens rifler with the precision traditionally associated with low-sensitivity AWPers, a contradiction that shouldn't work but does because of his exceptional hand-eye coordination. On Aurora (formerly Eternal Fire), woxic has become the centerpiece of Turkey's strongest Counter-Strike roster, leading a squad that includes fellow Turkish star XANTARES. His career has been marked by periods of incredible highs and frustrating inconsistency, but when woxic is in form, he is capable of outdueling any AWPer in the world through sheer speed of acquisition. The Turkish CS community idolizes woxic as the player who proved that an unconventional approach to the game can work at the highest level.",
    achievements: ["ESL Pro League S10 Champion (mousesports)", "cs_summit 5 Champion", "ICE Challenge 2020 Champion", "Aurora/Eternal Fire franchise AWPer", "Turkey's greatest AWPer", "Known for highest sensitivity among pros", "Multiple Tier 1 wins with mousesports", "DreamHack Open Tours 2019 Champion", "Proved high-sens AWPing viable at pro level", "Turkish CS icon"],
    mouseHistory: [{ mouse: "Razer Viper V3 Pro", period: "2024-Present" }, { mouse: "Razer Viper V2 Pro", period: "2023-2024" }, { mouse: "Logitech G Pro X Superlight", period: "2021-2023" }, { mouse: "Zowie EC2-B", period: "2019-2021" }],
  },
  { name: "XANTARES", game: "CS2", team: "Aurora", mouse: "ZOWIE FK1-C", hz: 1000, dpi: 400, sens: 2.3, edpi: 920, role: "Rifler", country: "🇹🇷", age: 29, fullName: "İsmailcan Dörtkardeş",
    bio: "İsmailcan 'XANTARES' Dörtkardeş is the undisputed greatest Turkish Counter-Strike player of all time, a rifler whose online statistics during his prime were so absurdly dominant that he earned the nickname 'The Turkish Terminator' and became the benchmark against which all CIS and Turkish talent is measured. During his years competing primarily in Turkish and European online leagues, XANTARES posted ratings that were consistently among the highest in the world, with his headshot percentage regularly exceeding 60% — a figure that suggested either superhuman crosshair placement or an aim style so precise that every bullet was placed exactly where intended. His move to BIG in 2019 was Turkey's first significant export to a top European team, and while the transition to consistent LAN performance took time, XANTARES showed flashes of the same dominance that had made him legendary online. On Aurora (formerly Eternal Fire), XANTARES has returned to lead Turkey's strongest roster alongside woxic, forming a Turkish duo that combines his rifling excellence with woxic's AWP brilliance. His influence on Turkish esports extends beyond his individual play — XANTARES proved that Turkish players could compete at the international level, opening doors for the generation of Turkish talent that followed him. Despite never winning a Major, XANTARES' statistical legacy and his role as Turkish Counter-Strike's founding international star ensure his place in the game's history.",
    achievements: ["ESL Pro League S10 Europe deep run (BIG)", "Multiple Turkish championship titles", "Highest headshot percentage in pro CS history", "Aurora/Eternal Fire franchise player", "Turkey's greatest CS player of all time", "BIG core member 2019-2022", "Known as 'The Turkish Terminator'", "PGL Major appearances", "60%+ headshot rate during peak", "Pioneered Turkish talent export to EU"],
    mouseHistory: [{ mouse: "ZOWIE FK1-C", period: "2022-Present" }, { mouse: "Zowie FK1-B", period: "2019-2022" }, { mouse: "Zowie FK1", period: "2016-2019" }],
  },
  { name: "Frozen", game: "CS2", team: "FaZe Clan", mouse: "Razer DeathAdder V4 Pro", hz: 4000, dpi: 400, sens: 2.0, edpi: 800, role: "Rifler", country: "🇸🇰", age: 22, fullName: "David Čerňanský",
    bio: "David 'frozen' Čerňanský is Slovakia's greatest Counter-Strike player, a rifler who has been competing at the highest level since joining mousesports at just fifteen years old and has since matured into one of the most reliable star players in the game. His journey from MOUZ prodigy to FaZe Clan franchise player represents a steady, controlled ascent through the ranks of professional CS, with frozen consistently improving year over year rather than peaking early and declining. On FaZe Clan, frozen has stepped into a star rifling role that demands both consistent fragging and the ability to take over maps in crucial moments, and his performances have justified the faith placed in him by one of esports' most prestigious organizations. His playing style combines disciplined crosshair placement with excellent utility usage, a combination that makes him both individually dangerous and tactically valuable within any system. Frozen's career arc shows a player who was always talented but needed time to develop the experience and composure necessary to translate that talent into consistent championship-level performance. Slovakia's Counter-Strike scene is small but proud, and frozen's success at the highest level has inspired a generation of Slovak players who previously had no domestic role model in the professional scene.",
    achievements: ["PGL Major Antwerp 2022 deep run (MOUZ)", "ESL Pro League S10 Champion (mousesports)", "FaZe Clan franchise rifler", "Slovakia's greatest CS player", "Competed professionally since age 15", "HLTV Top 20 contender (multiple years)", "Multiple Tier 1 playoff appearances", "Known for steady improvement trajectory", "DreamHack Open Champion", "Youngest mousesports roster member"],
    mouseHistory: [{ mouse: "Razer DeathAdder V4 Pro", period: "2024-Present" }, { mouse: "Razer Viper V3 Pro", period: "2023-2024" }, { mouse: "Logitech G Pro X Superlight", period: "2021-2023" }, { mouse: "Zowie S2", period: "2019-2021" }],
  },
  { name: "tabseN", game: "CS2", team: "BIG", mouse: "WLMouse BEAST X Mini Magnesium", hz: 1000, dpi: 800, sens: 0.7, edpi: 560, role: "Rifler/IGL", country: "🇩🇪", age: 30, fullName: "Johannes Wodarz",
    bio: "Johannes 'tabseN' Wodarz is the greatest German Counter-Strike player of all time and the heart and soul of BIG, an organization he has represented since its founding and through which he has built Germany's most successful CS legacy. His dual German-Turkish heritage — born in Germany to Turkish parents — gives him a unique perspective in the European scene, and his leadership of BIG has been defined by unwavering commitment to building a competitive German roster rather than chasing international super-teams. TabseN's individual talent has never been in question: his rifle mechanics are world-class, his AWP as a secondary weapon is among the best of any non-specialist, and his game sense allows him to make plays that create advantages from seemingly neutral positions. Under his leadership, BIG have achieved multiple deep runs at Major championships and won significant Tier 1 events, establishing themselves as a permanent fixture in the upper echelon of European Counter-Strike. His willingness to take on the IGL role when needed, despite being BIG's most individually talented player, demonstrates a selflessness that has earned him immense respect throughout the professional community. TabseN's longevity with a single organization is remarkable in an era of constant roster shuffling — his decade-plus commitment to BIG mirrors the loyalty that defined earlier Counter-Strike generations and stands as proof that building something lasting can be as rewarding as chasing trophies with super-teams.",
    achievements: ["DreamHack Masters Spring 2021 Champion", "ESL One Cologne 2020 Online Champion", "BIG franchise leader since founding", "Germany's greatest CS player", "Multiple Major playoff appearances", "Known for elite AWP as secondary weapon", "HLTV Top 20 contender", "10+ years with BIG organization", "IEM Katowice deep runs", "Pioneered German CS at international level"],
    mouseHistory: [{ mouse: "WLMouse BEAST X Mini Magnesium", period: "2025-Present" }, { mouse: "Logitech G Pro X Superlight", period: "2021-2025" }, { mouse: "Zowie EC2-B", period: "2018-2021" }],
  },
  { name: "Boombl4", game: "CS2", team: "BetBoom Team", mouse: "Razer DeathAdder V4 Pro", hz: 1000, dpi: 400, sens: 1.45, edpi: 580, role: "IGL", country: "🇷🇺", age: 26, fullName: "Kirill Mikhailov",
    bio: "Kirill 'Boombl4' Mikhailov was the in-game leader who guided Natus Vincere through their most dominant era, culminating in the PGL Major Stockholm 2021 championship that gave s1mple his first and most celebrated Major title. His calling style during NaVi's 2021 dominance was characterized by explosive, fast-paced executes that maximized s1mple's and electronic's ability to win aim duels before opponents could set up defensively, a philosophy that produced one of the most fearsome attacking teams in CS:GO history. The PGL Major Stockholm victory, where NaVi swept through the tournament with devastating efficiency, represented the peak of Boombl4's system — a team so well-coordinated and individually talented that opponents often looked helpless against their onslaughts. His departure from NaVi was one of the most discussed roster moves in CS history, as many felt the team's subsequent decline validated just how important his leadership had been to their success. On BetBoom Team, Boombl4 has worked to rebuild his reputation and prove that his tactical acumen extends beyond simply enabling the best player in the world. His career represents both the heights of what great IGL play can achieve and the volatile nature of esports careers, where a single roster change can alter trajectories overnight.",
    achievements: ["PGL Major Stockholm 2021 Champion", "Intel Grand Slam Season 4 (NaVi)", "ESL One Cologne 2021 Champion", "IEM Katowice 2022 Champion", "BLAST Premier World Final 2021", "NaVi IGL during dominant 2021 era", "BetBoom Team captain", "Led s1mple to first Major title", "Known for aggressive calling style", "Multiple HLTV MVP event finishes"],
    mouseHistory: [{ mouse: "Razer DeathAdder V4 Pro", period: "2024-Present" }, { mouse: "Razer DeathAdder V3 Pro", period: "2022-2024" }, { mouse: "Zowie EC2-B", period: "2019-2022" }],
  },
  { name: "Jame", game: "CS2", team: "PARIVISION", mouse: "Logitech G Pro X Superlight 2", hz: 2000, dpi: 3200, sens: 0.3, edpi: 960, role: "AWPer/IGL", country: "🇷🇺", age: 27, fullName: "Dzhami Ali",
    bio: "Dzhami 'Jame' Ali is one of the most polarizing players in Counter-Strike history, an AWPer and in-game leader whose extremely passive, economy-focused playstyle has earned him both devoted admirers who appreciate his tactical depth and vocal critics who find his approach boring. The 'Jame time' meme — referring to his tendency to save his AWP rather than risk it in low-probability rounds — has become one of the most enduring jokes in the CS community, but it masks a genuinely effective tactical philosophy: Jame's teams consistently outperform their individual talent level because his system ensures they always have the economy to compete. Under his leadership, Virtus.pro became one of the most consistent CIS teams in CS:GO history, regularly qualifying for Major playoffs and competing against rosters with significantly more individual firepower. His AWPing style prioritizes survival and consistent damage output over highlight-reel plays, a mathematically sound approach that sacrifices excitement for reliability. The move to PARIVISION has seen Jame continue his patient approach to both IGLing and AWPing, building competitive rosters through tactical discipline rather than star power. Jame's legacy is ultimately that of an AWPer-IGL who proved that winning Counter-Strike doesn't require constant aggression — sometimes the smartest play is the one that preserves your team's ability to fight another round.",
    achievements: ["PGL Major Krakow 2024 Finalist", "CIS RMR #1 seed (multiple times)", "Virtus.pro/Outsiders franchise AWPer-IGL", "PARIVISION captain", "Known for 'Jame time' save culture", "Multiple Major playoff appearances", "IEM Beijing 2020 deep run", "Most economically efficient AWPer in CS", "CIS region's most successful IGL", "Pioneered passive AWP-IGL style"],
    mouseHistory: [{ mouse: "Logitech G Pro X Superlight 2", period: "2024-Present" }, { mouse: "Logitech G Pro X Superlight", period: "2021-2024" }, { mouse: "Logitech G Pro Wireless", period: "2019-2021" }],
  },
  { name: "hampus", game: "CS2", team: "Free Agent", mouse: "Razer DeathAdder Elite", hz: 1000, dpi: 400, sens: 1.67, edpi: 668, role: "IGL", country: "🇸🇪", age: 25, fullName: "Hampus Poser",
    bio: "Hampus Poser brought a new tactical identity to Ninjas in Pyjamas during his tenure as IGL, revitalizing a Swedish organization that had been struggling to recapture its former glory. His approach to in-game leadership blended aggressive T-side executes with flexible CT setups, a combination that made NIP competitive against teams with significantly more individual talent. Hampus was instrumental in NIP's run to the PGL Major Copenhagen 2024 final, where the team came agonizingly close to securing a Major championship that would have been the first for the organization in CS2. His calling style drew praise for its adaptability — hampus was willing to change tactics mid-match based on what the opponent showed, a flexibility that kept NIP competitive even when their initial game plan wasn't working. The Swedish IGL pipeline has produced legendary figures like Xizt, pronax, and Golden, and hampus established himself as the best Swedish caller of the CS2 era through consistent results and tactical innovation. His journey from relatively unknown Swedish talent to Major finalist IGL demonstrates the value of leadership development in Counter-Strike, where a great caller can transform a good roster into a championship contender.",
    achievements: ["PGL Major Copenhagen 2024 Finalist", "NIP franchise IGL", "IEM Dallas 2022 deep run", "Multiple Major playoff appearances", "Sweden's best IGL of CS2 era", "BLAST Premier appearances", "Revitalized NIP's tactical identity", "Known for adaptive calling style", "Led NIP to Major Final", "Multiple Tier 1 deep runs"],
    mouseHistory: [{ mouse: "Razer DeathAdder Elite", period: "2021-Present" }, { mouse: "Zowie EC2-B", period: "2019-2021" }],
  },
  { name: "nitr0", game: "CS2", team: "NRG", mouse: "Logitech G Pro X Superlight 2", hz: 500, dpi: 800, sens: 1.05, edpi: 840, role: "IGL", country: "🇺🇸", age: 29, fullName: "Nick Cannella",
    bio: "Nick 'nitr0' Cannella is the most successful North American in-game leader in Counter-Strike history, the captain who led Team Liquid through their legendary 2019 summer run that produced the Intel Grand Slam Season 2 and established the roster as the number one team in the world. That run — which saw Liquid win IEM Sydney, DreamHack Masters Dallas, ESL Pro League Season 9 Finals, and IEM Chicago in succession — remains the peak of North American Counter-Strike achievement, a period of dominance that proved NA teams could sustain excellence at the international level. Nitr0's calling style was built on preparation and flexibility, giving his star players EliGE, Twistzz, and NAF freedom to express their individual talent within a structured framework. His remarkable career detour into professional Valorant with 100 Thieves, where he competed at VCT events, makes him one of the few players to have competed professionally in both major tactical shooters. The return to Counter-Strike with NRG represented nitr0 coming home to the game that built his legacy, bringing years of additional competitive experience and leadership maturity. His longevity across multiple game titles and the respect he commands from both teammates and opponents speak to leadership qualities that transcend any single game — nitr0 is the type of player that organizations build around because his presence elevates everyone around him.",
    achievements: ["Intel Grand Slam Season 2 (Liquid)", "IEM Sydney 2019 Champion", "DreamHack Masters Dallas 2019 Champion", "ESL Pro League S9 Finals Champion", "IEM Chicago 2019 Champion", "BLAST Premier Spring 2020 Champion", "World #1 ranked team (Liquid 2019)", "Competed in both CS:GO and Valorant", "NRG IGL", "Most successful NA IGL in CS history"],
    mouseHistory: [{ mouse: "Logitech G Pro X Superlight 2", period: "2024-Present" }, { mouse: "Logitech G Pro X Superlight", period: "2022-2024" }, { mouse: "Logitech G Pro Wireless", period: "2019-2022" }],
  },
];
